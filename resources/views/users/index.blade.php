...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ trans('White Dashboard Laravel by Creative Tim & UPDIVISION') }}</title>
        <!-- Favicon -->
                ...
                <div class="wrapper">
                    <div class="sidebar">
                        <div class="sidebar-wrapper">
                            <div class="logo">
                                <a href="#" class="simple-text logo-mini">{{ trans('WD') }}</a>
                                <a href="#" class="simple-text logo-normal">{{ trans('White Dashboard') }}</a>
                            </div>
                            <ul class="nav">
                                <li>
                                    <a href="{{ route('home') }}">
                                ...
                                <li>
                                    <a data-toggle="collapse" href="#laravel-examples" aria-expanded="true">
                                        ...
                                        <span class="nav-link-text" >{{ trans('Laravel Examples') }}</span>
                                ...
                                <li >
                                    <a href="{{ route('pages.tables') }}">
                                        ...
                                        <p>{{ trans('Table List') }}</p>
                                    </a>
                                </li>
                                <li >
                                    <a href="{{ route('pages.typography') }}">
                                        <i class="tim-icons icon-align-center"></i>
                                        <p>{{ trans('Typography') }}</p>
                                    </a>
                                </li>
                                <li >
                                    <a href="{{ route('pages.rtl') }}">
                                        <i class="tim-icons icon-world"></i>
                                        <p>{{ trans('RTL Support') }}</p>
                                    </a>
                                </li>
                                 <li class="bg-info">
                                    <a href="{{ route('pages.upgrade') }}">
                                        <i class="tim-icons icon-spaceship"></i>
                                        <p>{{ trans('Upgrade to PRO') }}</p>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="dropdown nav-item">
                                    ...
                                    <ul class="dropdown-menu dropdown-navbar">
                                        <li class="nav-link">
                                            <a href="{{ route('profile.edit') }}" class="nav-item dropdown-item">{{ trans('Profile') }}</a>
                                        </li>
                                        <li class="nav-link">
